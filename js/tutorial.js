 ...
 *    queda afuera a propósito — el menú está deshabilitado por ahora (ver
 *    conversación de agosto 2026: el backend sigue archivando precios en
 *    silencio, pero la sección todavía no se muestra a los usuarios).
...
function tutorialHtmlMockInterno(nombreSeccion) {
  ...
  const mocks = {
    ...
    // deshabilitado por ahora, ver conversación de agosto 2026: el backend
    // sigue archivando precios en silencio, pero la sección todavía no se
